...
export class DemoDataStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const imported_amplify_frontend_app_id = cdk.Fn.importValue('amplify-frontend-app-id');
    const imported_code_repo_branch_name = cdk.Fn.importValue('code-repo-branch-name');
    const imported_code_repo_arn = cdk.Fn.importValue('code-repo-arn');
    ...
    const amplifyJobParameters = {
      "appId": imported_amplify_frontend_app_id,
      "branchName": imported_code_repo_branch_name,
      "jobType": "RELEASE",
    ...
    const amplifyStartJobAction = {
      ...
      physicalResourceId: customResources.PhysicalResourceId.of(imported_amplify_frontend_app_id)
    }
    ...
    new customResources.AwsCustomResource(this, 'custom-resource-amplify-start-job', {
      ...
      policy: customResources.AwsCustomResourcePolicy.fromStatements([
        new iam.PolicyStatement({
          resources: [imported_code_repo_arn + "/jobs/*"],
